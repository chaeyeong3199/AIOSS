...
- [x] 2개 Milestone 구성 완료
	- AI OSS 중간 점검 (W1-8)
	- URL: [milestone/2](/chaeyeong3199/AIOSS/milestone/2)
	- AI OSS 프로젝트 완성
	- URL: [milestone/1](/chaeyeong3199/AIOSS/milestone/1)
- [x] 10개 이슈 생성 및 milestone 연결 완료 (#19~#28)
	- 이슈 목록 URL: [issues](/chaeyeong3199/AIOSS/issues)
	- 대표 이슈 URL: [#19](/chaeyeong3199/AIOSS/issues/19), [#28](/chaeyeong3199/AIOSS/issues/28)
- [x] 이슈 템플릿 2종 추가 완료
...
- [x] 라벨 체계 구축 및 일괄 적용 완료
	...
	- URL: [labels](/chaeyeong3199/AIOSS/labels)
